...
class InternalOrganizationCreationView(APIView):
    ...
    @extend_schema(
        ...
        **Flow:**
        - Validates input (name required, plan/quota optional).
        - Executes management command.
        - Parses output for ID and API key.
        - Handles errors gracefully (e.g., command failure, parsing issues).
        ''',
        tags=['Internal'],
        request=OrganizationSerializer,  # Improved: Use serializer for request body
        responses={
            201: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        description='Example of successful creation with ID and key.',
                        value={
                            'success': True,
                            'data': {
            ...
            400: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Bad request - missing name or invalid input',
                examples=[
                    OpenApiExample(
                        'Missing Name',
                        value={
            ...
            500: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Internal server error - command failure or unexpected issue',
                examples=[
                    OpenApiExample(
                        'Command Error',
                        value={
                            ...
                            'message': 'Command failed: [error details]',
                            'meta': get_standard_meta()
                        }
                    )
                ]
        ...
        parameters=[
            OpenApiParameter(
                ...
                required=True,
                description='Internal service secret for authentication (apiKey scheme)'
            ),
        ],
        examples=[
            OpenApiExample(
                'Create Pro Org',
                summary='Create organization with pro plan',
                description='Example request body for creating an org.',
                value={
                    'name': 'Acme Corp',
                    'plan': 'pro',
                    'quota': 10000
...
class NotificationAPIView(AsyncAPIView):
    ...
    @extend_schema(
        ...
        **Idempotency:** Uses request_id to prevent duplicates (10-min cache).
        **Async:** Publishes to RabbitMQ queue for workers.
        ''',
        tags=['Notifications'],
        ...
        responses={
            202: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        description='Example of successful acceptance with IDs.',
                        value={
                            'success': True,
                            'data': {
            ...
            400: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Bad request - missing fields, invalid type, missing variables, no push token',
                examples=[
                    OpenApiExample(
                        'Missing Fields',
                        value={
            ...
            403: OpenApiResponse(
                description='Forbidden - user opted out of notifications'
            ),
            404: OpenApiResponse(
                description='Not found - user or template does not exist'
            ),
            429: OpenApiResponse(
            ...
            500: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Internal server error - unexpected failure (e.g., queue publish error)',
                examples=[
                    OpenApiExample(
                        'Server Error',
                        value={
        ...
        parameters=[
            OpenApiParameter(
                ...
                location=OpenApiParameter.HEADER,
                required=True,
                description='Organization API key for authentication (apiKey scheme)',
                examples=[
        ...
        examples=[
            OpenApiExample(
                ...
                description='Request for welcome email with variables.',
                value={
            ...
            OpenApiExample(
                ...
                description='Request for push alert.',
                value={
...
class NotificationStatusCheckView(AsyncAPIView):
    ...
    @extend_schema(
        ...
        **Notes:**
        - Requires the notification to belong to the authenticated organization.
        ...
        responses={
            ...
            400: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Bad request - missing notification_id',
                examples=[
                    OpenApiExample(
                        'Missing ID',
                        value={
            ...
            404: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Not found - notification does not exist or not owned by org',
                examples=[
                    OpenApiExample(
                        'Not Found',
                        value={
        ...
        parameters=[
            OpenApiParameter(
                ...
                location=OpenApiParameter.HEADER,
                required=True,
                description='Organization API key (apiKey scheme)'
            ),
        ],
        examples=[
            OpenApiExample(
...
class InternalStatusView(AsyncAPIView):
    ...
    @extend_schema(
        ...
        **Valid Statuses:** queued, processing, delivered, failed, bounced, rejected
        ''',
        tags=['Internal'],
        ...
        responses={
            200: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Status updated successfully or already updated (idempotent)',
                examples=[
                    OpenApiExample(
                        'Updated',
                        value={
                ...
                examples=[
                    OpenApiExample(
                        ...
                        value={
                            'success': False,
                            'error': 'Invalid status',
                            'message': 'status must be one of [queued, processing, delivered, failed, bounced, rejected]',
                            'meta': get_standard_meta()
                        }
                    )
                ]
            ...
            500: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Internal error - DB/update failure',
                examples=[
                    OpenApiExample(
                        'Error',
                        value={
        ...
        parameters=[
            OpenApiParameter(
                ...
                location=OpenApiParameter.HEADER,
                required=True,
                description='Internal service secret key (apiKey scheme, not X-API-Key)'
            ),
            OpenApiParameter(
        ...
        examples=[
            ...
            OpenApiExample(
                'Failed Update',
                summary='Report failed with error',
                value={
                    'notification_id': 'xyz789abc',
                    'organization_id': 'org_456',
                    'status': 'failed',
...
class HealthCheckView(AsyncAPIView):
    ...
    @extend_schema(
        ...
        **Async:** Parallel checks with asyncio.gather for speed.
        ''',
        tags=['System'],
        responses={
            200: OpenApiResponse(
...
class UserServiceView(APIView):
    ...
    @extend_schema(
        ...
        **Path Variations:**
        - /users/{user_id}/ : Get full user profile.
        - /users/{user_id}/preferences/ : Get preferences only.
        - /health/ : Proxy health check to upstream.
        ''',
        tags=['Users'],
        responses={
            200: OpenApiResponse(
            ...
            400: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Bad request - missing X-Organization-ID header',
                examples=[
                    OpenApiExample(
                        'Missing Header',
                        value={
            ...
            502: OpenApiResponse(
                description='Bad gateway - user service unavailable or invalid response'
            ),
        },
        parameters=[
            OpenApiParameter(
                ...
                type=OpenApiTypes.STR,
                location=OpenApiParameter.PATH,
                required=False,  # Conditional based on path
                description='User ID (required for /users/{user_id})'
            ),
            OpenApiParameter(
            ...
            OpenApiParameter(
                ...
                location=OpenApiParameter.HEADER,
                required=True,
                description='API Key for authentication (apiKey scheme)'
            ),
        ]
    )
    ...
    @extend_schema(
        ...
        **This is a proxy endpoint** that forwards to the real user service.
        Validates organization ID and forwards with internal auth.
        ''',
        tags=['Users'],
    ...
    @extend_schema(
        ...
        **This is a proxy endpoint** that forwards to the real user service.
        Validates organization ID and forwards.
       
        **Path Variations:**
        - /users/{user_id}/ : Update full profile (PATCH).
        - /users/{user_id}/preferences/ : Update preferences only.
        ''',
        tags=['Users'],
        ...
        responses={
            ...
            400: OpenApiResponse(description='Bad request - missing user_id or invalid data'),
...
class InternalOrganizationSyncView(AsyncAPIView):
    ...
    @extend_schema(
        ...
        **Flow:**
        - Validates required fields (id, name, api_key, etc.).
        - Forwards to template service via POST.
        ...
        responses={
            201: OpenApiResponse(
                response=StandardResponseSerializer,
                description='Organization synced to template service',
                examples=[
                    OpenApiExample(
                        'Synced',
                        value={
            ...
            502: OpenApiResponse(
                description='Bad gateway - template service unavailable'
            ),
            500: OpenApiResponse(
                response=StandardResponseSerializer,
        ...
        parameters=[
            OpenApiParameter(
                ...
                location=OpenApiParameter.HEADER,
                required=True,
                description='Internal service secret (apiKey scheme)'
            ),
        ],
        examples=[
            OpenApiExample(
...
class TemplateDocsProxyView(APIView):
    ...
    @extend_schema(
        operation_id='proxy_template_docs_get',
        summary='Proxy GET to template service docs/UI',
        description='''
        Proxy GET requests to template service's Swagger/Redoc UI or assets.
       
        - Adds internal secret for auth.
        - Streams content for efficiency.
        - Handles external redirects (e.g., CDN).
        ''',
        tags=['Proxy'],
        responses={
            200: OpenApiResponse(
                description='Proxied content (HTML, JSON, etc.)',
                content={'application/json': {}, 'text/html': {}}
            ),
            502: OpenApiResponse(description='Bad gateway - template service unavailable'),
            500: OpenApiResponse(description='Internal proxy error'),
        },
        parameters=[
            OpenApiParameter(
                name='path',
                ...
                location=OpenApiParameter.PATH,
                required=False,
                description='Path to proxy (e.g., api/docs/, swagger.json)'
            ),
        ]
    )
    ...
    @extend_schema(
        operation_id='proxy_template_docs_post',
        summary='Proxy POST to template service (e.g., for Swagger Try it out)',
        description='''
        Proxy POST requests for interactive features like 'Try it out' in Swagger UI.
       
        - Adds internal secret.
        - Forwards body and headers.
        ''',
        tags=['Proxy'],
        request=OpenApiTypes.OBJECT,  # Generic object for try-it-out
        responses={
            200: OpenApiResponse(description='Proxied response'),
            502: OpenApiResponse(description='Bad gateway - template service unavailable'),
            500: OpenApiResponse(description='Internal proxy error'),
        },
        parameters=[
            OpenApiParameter(
                ...
                location=OpenApiParameter.PATH,
                required=False,
                description='Path to proxy (e.g., api/v1/templates/)'
            ),
        ]
    )
...
class TemplateDocsProxyView(APIView):
    ...
    @extend_schema(
        operation_id='proxy_template_docs',
        summary='Proxy to template service docs/UI',
        description='''
        Proxy requests to template service's Swagger/Redoc.
       
        - Cleans and forwards path.
        - Redirects external URLs (e.g., CDN).
        - Streams for large assets.
        ''',
        tags=['Proxy'],
        responses={
            200: OpenApiResponse(description='Proxied content (HTML/JSON)'),
            302: OpenApiResponse(description='Redirect to external URL'),
        ...
        parameters=[
            OpenApiParameter(
                ...
                location=OpenApiParameter.PATH,
                required=False,
                description='Path to proxy or external URL'
            ),
        ]
    )
    def get(self, request, path=''):
